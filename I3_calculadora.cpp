...
//Tarea2: (Juan Francisco Cortejosa) {hizo la función restar, pero puso su 
//nombre en la de multiplicar} A?adir funcion para restar
//y modificar el la opcion 2 del switch para que
//invoque a la funcion restar con los par?metros correctos.

//Tarea3 (Alejandro Basallote): A?adir funci?n para multiplicar
